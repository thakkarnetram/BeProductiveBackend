...
- added a missing decryption handler in todoSchema causing conflicts [`#84`](https://github.com/thakkarnetram/BeProductiveBackend/pull/84)
- Minor Fixes for decrypt function  [`#83`](https://github.com/thakkarnetram/BeProductiveBackend/pull/83)
- Encryption Decryption Notes:To-do's  and New Updated Models for Both [`#82`](https://github.com/thakkarnetram/BeProductiveBackend/pull/82)
- fix: saving isEmailVerified value after otp is verified [`#81`](https://github.com/thakkarnetram/BeProductiveBackend/pull/81)
- Return User Object when auth is successful  [`#80`](https://github.com/thakkarnetram/BeProductiveBackend/pull/80)
- Fixed : Edge Case in Signup Authentication [`#79`](https://github.com/thakkarnetram/BeProductiveBackend/pull/79)
- Revamp authentication  [`#78`](https://github.com/thakkarnetram/BeProductiveBackend/pull/78)
- added timestamps in database models for created and updated field [`#77`](https://github.com/thakkarnetram/BeProductiveBackend/pull/77)
- fcm handling & notifications  [`#76`](https://github.com/thakkarnetram/BeProductiveBackend/pull/76)
...
- added channel name in notification object for further process [`7c11d5b`](https://github.com/thakkarnetram/BeProductiveBackend/commit/7c11d5b66fa246a66bc9bae0621f63765df3ee04)
...
- added encryption to notes and todos , refactored updating todo and notes logic to sync it up with encryption process , added new parameters to todo model for further implementations [`10e2bd0`](https://github.com/thakkarnetram/BeProductiveBackend/commit/10e2bd043b6daddbc25cf21174307860a446cd26)
- chore: update CHANGELOG.md [skip ci] [`ed357ea`](https://github.com/thakkarnetram/BeProductiveBackend/commit/ed357ea6f072b3b21bc8b76cc6109b6fa0112fa7)
- chore: update CHANGELOG.md [skip ci] [`adf6836`](https://github.com/thakkarnetram/BeProductiveBackend/commit/adf68363e6e9968e34489329cdb430f560c8c17e)
...
- handling of fcm tokens adding and removal , sending notifications to people in channels [`eb9e16c`](https://github.com/thakkarnetram/BeProductiveBackend/commit/eb9e16cb6d33fc3e8ef6921e0eff0ef75a8b79d8)
- chore: update CHANGELOG.md [skip ci] [`34a2aaa`](https://github.com/thakkarnetram/BeProductiveBackend/commit/34a2aaade12866d1b3a9c8802c038aadca173fc5)
- made few additions in notification model , added api for getting mentions and general notification to display in application [`f68104b`](https://github.com/thakkarnetram/BeProductiveBackend/commit/f68104be2dc6fc745673301d06d3da73de2dbdfc)
- chore: update CHANGELOG.md [skip ci] [`a5d1603`](https://github.com/thakkarnetram/BeProductiveBackend/commit/a5d16032c3b942baaa128af5a095ae46f00bc93f)
- fixed caching issue and create a single cache for workspace and channel controller [`82b802d`](https://github.com/thakkarnetram/BeProductiveBackend/commit/82b802d70cf8cd5fe10701de0975d1fd7b5f2b75)
- chore: update CHANGELOG.md [skip ci] [`0213a8c`](https://github.com/thakkarnetram/BeProductiveBackend/commit/0213a8cacb380509bf127bcdc68a7d448850bbf3)
...
- chore: update CHANGELOG.md [skip ci] [`f31fa71`](https://github.com/thakkarnetram/BeProductiveBackend/commit/f31fa711de7793b8a34ae1c4a97380426712e502)
...
- chore: update CHANGELOG.md [skip ci] [`6c31dfe`](https://github.com/thakkarnetram/BeProductiveBackend/commit/6c31dfead6e833a68f9109d1dd287c040619460f)
- fixed stale keys in invite controller , fixed socket logic to send notifications to admin's as well [`1adf7b7`](https://github.com/thakkarnetram/BeProductiveBackend/commit/1adf7b7126d6b33bcb9a24227ddcbceb7216f9cd)
...
- added conditions for sending notifications to users , as it was sending 2 notifications normal and mentioned ones which wasn't needed [`1730d17`](https://github.com/thakkarnetram/BeProductiveBackend/commit/1730d1787dab45f1883c4b748954dd1d56dca12f)
- added subscription based user model schema and updated existing user's schema to show new fields [`973591c`](https://github.com/thakkarnetram/BeProductiveBackend/commit/973591cfe5baa72ea192849e2b29a47a64946f41)
- fixed few flaws in joining workspace via links , fixed socket file to store notifications properly [`89005ab`](https://github.com/thakkarnetram/BeProductiveBackend/commit/89005ababd028333e491dfaabdd2784e6f6f43b9)
- added webhook to send feedbacks in discord server, added channelId parameter in notifications modal and sending channelId in notifications data to user [`f5dae5c`](https://github.com/thakkarnetram/BeProductiveBackend/commit/f5dae5ca58166c871993284446047e5dc44b71cf)
- changed workspace and channel model to avoid conflicts , revamp for channel and workspace controllers [`873e10c`](https://github.com/thakkarnetram/BeProductiveBackend/commit/873e10c595f72175060e6e999a707192eadae50e)
...
- added mention notifications [`eea95ac`](https://github.com/thakkarnetram/BeProductiveBackend/commit/eea95ac2d457f0645bbd72759283c90e2d95e0ec)
- added model for notifications for further processing [`54f8f27`](https://github.com/thakkarnetram/BeProductiveBackend/commit/54f8f27c680c4123aaba0bc5e44899fedd0d9e0c)
- changed the signup login verification flow to directly otp based verification to avoid user leaving the application [`4208b56`](https://github.com/thakkarnetram/BeProductiveBackend/commit/4208b56727ad726aa9b69293335f557bd096544e)
...
- chore: update CHANGELOG.md [skip ci] [`2b7aac9`](https://github.com/thakkarnetram/BeProductiveBackend/commit/2b7aac9b9b6df09805614cd9d28ed8cd45366b47)
- chore: update CHANGELOG.md [skip ci] [`9c1e533`](https://github.com/thakkarnetram/BeProductiveBackend/commit/9c1e53321e78d0cd59e57aad352e64d6eaaa6c6d)
...
- added safety check for decrypt function as old notes and tasks were not encrypted [`fc8ccdc`](https://github.com/thakkarnetram/BeProductiveBackend/commit/fc8ccdc5bc1071955693c66bafbf3d89e45ab028)
- added route for sending user id's in channel for @ mentions [`03590a6`](https://github.com/thakkarnetram/BeProductiveBackend/commit/03590a632641db43e9669871a3f1aa5d25f60212)
...
- chore: update CHANGELOG.md [skip ci] [`8e88246`](https://github.com/thakkarnetram/BeProductiveBackend/commit/8e88246e65301071f44e172013f1e2ac3cbb5d30)
...
- chore: update CHANGELOG.md [skip ci] [`7add591`](https://github.com/thakkarnetram/BeProductiveBackend/commit/7add59197212fdc7189ed4a91148111d40daf3a8)
- chore: update CHANGELOG.md [skip ci] [`084c0f1`](https://github.com/thakkarnetram/BeProductiveBackend/commit/084c0f14263c1638ff7d73f7b8bbe18ff3c2edbb)
- chore: update CHANGELOG.md [skip ci] [`6a7092e`](https://github.com/thakkarnetram/BeProductiveBackend/commit/6a7092e769ac0d02f2754d6feeff488ae5f01246)
...
- chore: update CHANGELOG.md [skip ci] [`34934a1`](https://github.com/thakkarnetram/BeProductiveBackend/commit/34934a19bf1e7ab375dfd539e7cb276865443eb7)
- chore: update CHANGELOG.md [skip ci] [`7fa9e07`](https://github.com/thakkarnetram/BeProductiveBackend/commit/7fa9e079222adc9012ab85f7d2894695a7af46ec)
- updated auth signup controller to handle a case where user exists but email not verified so otp is resent to them [`ff8e007`](https://github.com/thakkarnetram/BeProductiveBackend/commit/ff8e007ef1be7cea458a791ccb2f1f06ddad2589)
- chore: update CHANGELOG.md [skip ci] [`e7b2d69`](https://github.com/thakkarnetram/BeProductiveBackend/commit/e7b2d69b16b3f02427176580bd8594896ac3f158)
...
- chore: update CHANGELOG.md [skip ci] [`0e919d9`](https://github.com/thakkarnetram/BeProductiveBackend/commit/0e919d9f3075de63747396cbe1a36ec1547f836d)
...
- chore: update CHANGELOG.md [skip ci] [`a82b3bc`](https://github.com/thakkarnetram/BeProductiveBackend/commit/a82b3bc25ff4fef5e24f314452043c9178a37052)
...
- chore: update CHANGELOG.md [skip ci] [`47b7f81`](https://github.com/thakkarnetram/BeProductiveBackend/commit/47b7f8116f0d02ace56c24f2b118e89a0408f770)
- removed regex for pass in reset [`7a85d24`](https://github.com/thakkarnetram/BeProductiveBackend/commit/7a85d24940a72544c36e5a295a4a70ba65812de6)
...
- removed strong password validation [`e322950`](https://github.com/thakkarnetram/BeProductiveBackend/commit/e322950324325c8d1188efd60043f746947b8d09)
- fixed stale cached keys for create channel [`a075723`](https://github.com/thakkarnetram/BeProductiveBackend/commit/a075723f7fd4288baebba1da8712bd0c8188fffd)
- chore: update CHANGELOG.md [skip ci] [`5c057a3`](https://github.com/thakkarnetram/BeProductiveBackend/commit/5c057a3546c4eb0af53d48d422bdaf7ece0ca1f6)
- chore: update CHANGELOG.md [skip ci] [`0c45548`](https://github.com/thakkarnetram/BeProductiveBackend/commit/0c45548474782d749cf8fe83dbfd4b5e4952fbe9)
- chore: update CHANGELOG.md [skip ci] [`e54827b`](https://github.com/thakkarnetram/BeProductiveBackend/commit/e54827ba0339473d3e3b51b54234213b9fc2286c)
- chore: update CHANGELOG.md [skip ci] [`21bcd0e`](https://github.com/thakkarnetram/BeProductiveBackend/commit/21bcd0ee424aa2fabd348989c7a5d6a2abeb0445)
- chore: update CHANGELOG.md [skip ci] [`16dc8da`](https://github.com/thakkarnetram/BeProductiveBackend/commit/16dc8da7f16de37510b461a25abc5debb62b7dde)
...
- chore: update CHANGELOG.md [skip ci] [`4cb72f6`](https://github.com/thakkarnetram/BeProductiveBackend/commit/4cb72f68f1094b4afa0eda7574e3fe9d9676fe16)
- chore: update CHANGELOG.md [skip ci] [`1785e46`](https://github.com/thakkarnetram/BeProductiveBackend/commit/1785e4693ead25bcf3e19c7b6a10618a6e12982a)
- fixed password regex [`30a921a`](https://github.com/thakkarnetram/BeProductiveBackend/commit/30a921a96a9973df089c886f890d235646d27a53)
- chore: update CHANGELOG.md [skip ci] [`b8b1735`](https://github.com/thakkarnetram/BeProductiveBackend/commit/b8b1735394eb3ad3be0440fc8c9578c9eff53aa4)
- chore: update CHANGELOG.md [skip ci] [`c7da8f0`](https://github.com/thakkarnetram/BeProductiveBackend/commit/c7da8f0f2c9fa31602cc4eb182a4100bfc7b0986)
...
- added firebase json file as env : [`b125721`](https://github.com/thakkarnetram/BeProductiveBackend/commit/b125721c9f2f7678a1afa0513e41ad5d62c4285d)
...
- returning user object in verification otp for further operations in frontend [`1593095`](https://github.com/thakkarnetram/BeProductiveBackend/commit/15930950cc60bdfc0391d7c2d488e5c14a15ceff)
- typo fix [`da2b50c`](https://github.com/thakkarnetram/BeProductiveBackend/commit/da2b50c0ffc4871771ba48ddb1a56d0f1682378e)
- commented out migration function which could cause unexpected server kills [`553fc72`](https://github.com/thakkarnetram/BeProductiveBackend/commit/553fc72b4bc7286e773f9db373236304e64a4c44)
